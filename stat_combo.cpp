...
q2.prepare("SELECT * FROM employes WHERE COMBO='choix1'");
q2.exec();

q3.prepare("SELECT * FROM employes WHERE COMBO='choix2'");
q3.exec();

q4.prepare("SELECT * FROM employes WHERE COMBO='choix3' ");
q4.exec();
...
//pie chart
    ...
    q4.prepare("SELECT * FROM employes WHERE COMBO='equipements' ");
    q4.exec();
